package com.demotivirus.Day_187_S2.lambda_example.solutions.CodeEvolution_5;
    ...
    private static void printMessages(List<Message> messages,
        ...
        for (Message message : messages) {
            if (predicate.test(message)) {
                String textFromMessage = function.apply(message);
                consumer.accept(textFromMessage);
            }
        }
    }
}
